...
package org.snailya.bnw.data

import org.snailya.base.simpleserialization.*
import org.snailya.base.math.*
...
data class PlayerCommandsMessage(
    ...
    companion object : KotlinSerializationAdapter<PlayerCommandsMessage>() {
        ...
        override fun parse(b: ByteBuffer): PlayerCommandsMessage {
            return PlayerCommandsMessage(b.getInt(), b.getInt(), PlayerCommand.listAdapter.parse(b), (b.get() == 1.toByte()))
        }

        override fun serialize(b: ByteBuffer, t: PlayerCommandsMessage) {
            IntAdapter.serialize(b, t.tick); IntAdapter.serialize(b, t.debug_hash); PlayerCommand.listAdapter.serialize(b, t.commands); BooleanAdapter.serialize(b, t.debug_resend)
        }
    }
}
data class GameCommandsMessage(
    ...
    companion object : KotlinSerializationAdapter<GameCommandsMessage>() {
        ...
        override fun parse(b: ByteBuffer): GameCommandsMessage {
            return GameCommandsMessage(b.getInt(), PlayerCommand.listAdapter.listAdapter.parse(b), (b.get() == 1.toByte()))
        }

        override fun serialize(b: ByteBuffer, t: GameCommandsMessage) {
            IntAdapter.serialize(b, t.tick); PlayerCommand.listAdapter.listAdapter.serialize(b, t.commands); BooleanAdapter.serialize(b, t.debug_resend)
        }
    }
}
