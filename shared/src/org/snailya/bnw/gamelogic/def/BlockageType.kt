 ...
 */
open class FreeFormBlockageType(val connectRoof: Boolean, val baseWalkSpeed: Float = 0F) : Def {
...
class MineralBlockageType(val mineral: Mineral) : FreeFormBlockageType(true)
